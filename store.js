...
export async function getSongs() {
  let songs = await get('Playjoor-songs');
  ...
  if (!songs) {
    ...
    await set('Playjoor-songs', songs);
...
export async function setVolume(volume) {
  await set('Playjoor-volume', volume);
}
...
export async function getVolume() {
  return await get('Playjoor-volume');
}
...
export async function setCustomSkin(skin) {
  await set('Playjoor-customSkin', skin);
}
...
export async function getCustomSkin(skin) {
  return await get('Playjoor-customSkin');
}
...
export async function setArtwork(artist, album, image) {
  let artworks = await get('Playjoor-artworks');
  if (!artworks) {
    artworks = {};
  }
  artworks[`${artist}-${album}`] = image;
  await set('Playjoor-artworks', artworks);
}
...
export async function getArtworks() {
  return await get('Playjoor-artworks') || {};
}
